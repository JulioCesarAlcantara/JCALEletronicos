...
DROP SCHEMA IF EXISTS `jcalEletronicos` ;
CREATE SCHEMA IF NOT EXISTS `jcalEletronicos` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci ;
USE `jcalEletronicos` ;
...
CREATE TABLE IF NOT EXISTS `jcalEletronicos`.`Usuario` (
  ...
  `primeiroNomeUsuario` VARCHAR(45) NOT NULL,
  `segundoNomeUsuario` VARCHAR(45) NOT NULL,
  ...
  `enderecoUsuario` VARCHAR(200) NULL,
